...
- The 2026-09-14 request authorizes exploratory inference diagnostics on 32 fixed training and 32 existing validation images, not training or checkpoint reselection. The selected weight is a diagnostic object, not a performance-accepted research model. Preserve the initial diagnostic protocol, code amendments, failed attempts, and actual paired noise tensors; do not modify the frozen runtime.
